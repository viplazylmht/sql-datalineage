...
class TestSqlalchemySchemaRetriever(TestSchemaRetrieverBase):
    ...
    def validate_sqlite_retriever(self, sqlite_retriever: SQLAlchemySchemaRetriever):
        ...
        sqlite_retriever.retrieve_schema(tables=[message_table, profile_table, unknown_table])
        schema = sqlite_retriever.schema
